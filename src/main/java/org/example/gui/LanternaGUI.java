...
public class LanternaGUI implements GUI{
    ...
    public ACTION getNextAction() throws IOException {
        ...
        if (keyStroke.getKeyType() == KeyType.ArrowUp) return ACTION.UP1;
        if (keyStroke.getKeyType() == KeyType.ArrowRight) return ACTION.RIGHT1;
        if (keyStroke.getKeyType() == KeyType.ArrowDown) return ACTION.DOWN1;
        if (keyStroke.getKeyType() == KeyType.ArrowLeft) return ACTION.LEFT1;
    ...
    public void drawPlayer2(Position position) {
        drawCharacter(position.getX(), position.getY(), '@', "#50D4D4");
    }


    @Override
    public void drawPath1(Position position) {
        drawCharacter(position.getX(), position.getY(), '#', "#FFD700");
    }

    @Override
    public void drawPath2(Position position) {
        drawCharacter(position.getX(), position.getY(), '#', "#50D4D4");
    }
